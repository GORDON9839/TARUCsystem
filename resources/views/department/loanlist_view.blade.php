...
<html>
<head>
    <title>View All Accommodations</title>
    <meta charset="utf-8" />
    ...
    <div id="main" class="wrapper style1">
        <div class="container">
            ...
            <?php
                    ...
                    $faculty = new XSLTTrans("/xampp/htdocs/TARUCsystem/resources/views/XML/loanlist.xml","/xampp/htdocs/TARUCsystem/resources/views/xslt/loanlist.xsl");
                    ?>
                <br/>
            </section>
        </div>
