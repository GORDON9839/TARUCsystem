                    ...
                    <div style="text-align: center">
                        ...
                        <div style="width: 20%; display: inline-block">
                            ...
                            <select id="dropdownfaculty" name="faculty" style="width: 90%;">
                                ...
                                ?>
                                <option
                                    value="<?php echo $facattr['faculty_id'];?>"><?php echo $fac->faculty_name;?></option>
                                <?php } ?>
                            </select>
                        </div>
                        ...
                        <div style="width: 20%; display: inline-block">
                            ...
                            <select id="dropdownlevel_of_study" name="level_of_study" style="width: 90%">
                                ...
                                ?>
                                <option
                                    value="<?php echo $levosattr['level_of_study_id'];?>"><?php echo $levos->level_of_study_name;?></option>
                                <?php } ?>
                            </select>
                        </div>
                        ...
                        <div style="width: 20%; display: inline-block">
                            ...
                            <select id="dropdowncampus" name="campus" style="width: 90%">
                                ...
                                ?>
                                <option
                                    value="<?php echo $camattr['campus_id'];?>"><?php echo $cam->campus_name;?></option>
                                <?php } ?>
                            </select>
                        </div>
